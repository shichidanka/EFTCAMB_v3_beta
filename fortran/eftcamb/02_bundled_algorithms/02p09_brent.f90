...
!> @file 02p09_brent.f90
!! This file contains the relevant code for the brent minimizer.
...
!----------------------------------------------------------------------------------------
!> This module contains the relevant code for the brent minimizer.

!> @author Marco Raveri

module EFTCAMB_brent_minimizer
...
end module EFTCAMB_brent_minimizer
