...
!> @file 02p07_NelderMead.f90
!! This file contains the relevant code for the double precision Nelder Mead minimization algorithm.
...
!----------------------------------------------------------------------------------------
!> This module contains the relevant code for the double precision Nelder Mead minimization algorithm.

!> @author Marco Raveri

module EFTCAMB_Nelder_Mead
...
end module EFTCAMB_Nelder_Mead
