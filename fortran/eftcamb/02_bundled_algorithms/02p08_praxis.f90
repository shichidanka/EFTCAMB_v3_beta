...
!> @file 02p08_praxis.f90
!! This file contains the relevant code for the praxis minimizer.
!! This code was developed by Richard Brent and John Burkardt that retain the copyright
!! for the following code.
!! This source file was modified to use it with the EFTCAMB code.

!----------------------------------------------------------------------------------------
!> This module contains the relevant code for the praxis minimizer.

!> @author Marco Raveri

module EFTCAMB_praxis_minimizer
...
end module EFTCAMB_praxis_minimizer
