...
!> @file 02p05_minpack.f90
!! This file contains the relevant code for the double precision MINPACK minimization library.
...
!----------------------------------------------------------------------------------------
!> This module contains the relevant code for the double precision MINPACK minimization library.

!> @author Marco Raveri

module EFTCAMB_minpack
