...
contains
    ...
    subroutine EFTCAMBReturnToGR_feedback( feedback_level, input_model, params_cache, initial_time, RGR_time, RGR_threshold )
        ...
        if ( feedback_level > 2 ) then
            ...
            if ( eft_functions(20) -RGR_threshold > 0._dl ) write(*,'(a18,E13.4)') '   EFTGamma6V   = ', eft_functions(18)
            if ( eft_functions(21) -RGR_threshold > 0._dl ) write(*,'(a18,E13.4)') '   EFTGamma6P   = ', eft_functions(19)
