    ...
    real(dl) clxq, vq, dgpnu, EFT_grhonu, EFT_gpinu, EFT_grhonudot, EFT_gpinudot, grhormass_t
    ...
    ! EFTCAMB MOD END.
        ...
        EV%eft_cache%gamma     = EFT_Phi/EFT_Psi -dgpi/k2/EFT_Psi/EV%eft_cache%mu
